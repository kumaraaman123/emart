...
const Product = () => {
    ...
    return (
        <div className='max-w-screen-xl mx-auto my-10 flex'>
            <div className='w-3/5 relative mr-10'>
            ...
            <div className='w-4/5 flex flex-col justify-center'>
                ...
                <div className='flex gap-4'>
                    <div className='w-52 flex items-center justify-between text-gray-500 gap-4 border p-5 border-black'>
                    ...
                    <button onClick={() => {
                        ...
                        className='bg-black text-white py-3 px-6 active:bg-gary-800'>add to cart</button>
                </div>
